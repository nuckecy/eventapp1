  ...
  const deptRows = await db
    ...
    .values([
      ...
      },
      {
        ...
        name: "Worship Team",
        icon: "🎵",
        lead_name: "Pastor John Emmanuel",
      ...
      },
      {
        ...
        icon: "🌍",
        lead_name: "Brother David Thompson",
